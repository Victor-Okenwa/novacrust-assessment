...
export default function HomePage() {
	const [convertCurrencyStep, setConvertCurrencyStep] = useState<ConvertCurrencyStepType>("convert");
			...
			<div className="py-5 px-2">
				<Tabs defaultValue="crypto-to-cash" className="max-w-lg col-span-3">
					...
					<TabsContent value="crypto-to-cash" className="max-w-lg mx-auto">
						<CashToCryptoTab step={convertCurrencyStep} setStep={setConvertCurrencyStep} />
					</TabsContent>
